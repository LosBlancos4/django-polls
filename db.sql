...
INSERT INTO django_migrations VALUES(22,'polls','0004_donation','2022-03-29 11:17:52.839169');
...
INSERT INTO django_content_type VALUES(11,'polls','donation');
...
INSERT INTO auth_permission VALUES(41,11,'add_donation','Can add donation');
INSERT INTO auth_permission VALUES(42,11,'change_donation','Can change donation');
INSERT INTO auth_permission VALUES(43,11,'delete_donation','Can delete donation');
INSERT INTO auth_permission VALUES(44,11,'view_donation','Can view donation');
...
INSERT INTO auth_user VALUES(2,'pbkdf2_sha256$320000$oLxBC9xOxSRPo57u39UiEr$g5BnGWNU0kE4Q9KmE38tCLrQ16X23F4oBd6Vg0EcH5A=','2022-03-29 11:25:26.974435',0,'john','','John.Batman@example.com',0,1,'2022-03-29 06:19:47.889818','');
...
INSERT INTO django_session VALUES('8lzmkxv6nndlksyjse6kduc1bq7e1acl','.eJxVjDsOwjAQBe_iGln-JU4o6TmDtd5d4wCypTipEHcHSymgnZn3XiLAvuWwN17DQuIsjDj9sgj44NIF3aHcqsRatnWJsifysE1eK_HzcrR_Bxla7us4aMSUHI9-ImSPzs7Io2ZLxKS0GXBOxiuP8cvcZAlUtI5schqSF-8PGGU47Q:1nZ9yY:DSJ7Gp-nVhzpIIcQz-ReW8xnWjr9mnBBdEjswG7taWg','2022-04-12 11:25:26.975249');
...
INSERT INTO polls_choice VALUES(2,'The Sky',7,1);
INSERT INTO polls_choice VALUES(3,'OKOK',5,1);
...
CREATE TABLE IF NOT EXISTS "polls_donation" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "donations" integer NOT NULL);
INSERT INTO polls_donation VALUES(1,213364);
...
INSERT INTO sqlite_sequence VALUES('polls_donation',1);
